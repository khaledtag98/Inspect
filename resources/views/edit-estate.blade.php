                    ...
                    <div class="px-4 py-5 bg-white sm:p-6">
                        <div class="grid grid-cols-6 gap-6">
                            <div class="col-span-6 sm:col-span-3">
                                ...
                                <input type="text" name="name" id="first_name" autocomplete="given-name" value="{{$estate->name}}"
                            ...
                            <div class="col-span-6 sm:col-span-3 lg:col-span-4">
                                ...
                                <input type="text" name="picture1" id="picture1" 
                                       autocomplete="picture1" placeholder=""
                                       class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            <div class="col-span-6 sm:col-span-3 lg:col-span-4">
                                ...
                                <input type="text" name="picture2" id="picture2"
                                       autocomplete="picture2" value="{{$picture2}}"
                                       class="block w-full mt-1 border-gray-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                            </div>
                            <div class="col-span-6 sm:col-span-3 lg:col-span-4">
