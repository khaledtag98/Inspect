                ...
                <div class="tab-slider--container">
                    <div id="tab1" class="tab-slider--body">
                        <form class="block -my-12">
                            <label>Email </label>
                            <input class="w-full px-2 py-2 mt-2 mb-4 shadow-md" type="email" name="" placeholder="" aria-describedby="helpId">
                            <label>Password </label>
                            <input class="w-full px-2 py-2 mt-2 shadow-md" type="password" name="" placeholder="" aria-describedby="helpId">
                            <div>
                                <a href=""
                    ...
                    <div id="tab2" class="tab-slider--body">
                        <form class="block -my-12">
                            ...
                            <div class='flex'>
                                <input class='w-1/2 px-2 py-2 mt-2 mb-4 mr-1 shadow-md' type="text" placeholder="First Name">
                                <input class='w-1/2 px-2 py-2 mt-2 mb-4 shadow-md' type="text" placeholder="Last Name">
                            </div>
                            <label>Email</label>
                            <input class="w-full px-2 py-2 mt-1 mb-4 shadow-md" type="email" name="" placeholder="" aria-describedby="helpId">
                            <label>Password </label>
                            <input class="w-full px-2 py-2 mt-1 mb-4 shadow-md" type="password" name="" placeholder="" aria-describedby="helpId">
                            <label>Confirm Password </label>
                            <input class="w-full px-2 py-2 mt-1 shadow-md" type="password" name="" placeholder="" aria-describedby="helpId">
                            <div>
                                <a href=""
                                    class="flex items-center justify-center w-1/2 px-8 py-3 m-auto mt-12 text-base font-medium leading-6 text-white transition duration-150 ease-in-out border border-transparent shadow bg-button1 btn hover-no-underline focus:outline-none focus:shadow-outline-indigo md:py-4 md:text-lg md:px-10">
                                    Register</a>
